...
func (wfnTheme) Color(c fyne.ThemeColorName, v fyne.ThemeVariant) color.Color {
	...
	case theme.ColorNameHover:
		return color.NRGBA{R: 0x25, G: 0x2d, B: 0x48, A: 0xf9}
	...
	case theme.ColorNamePrimary:
		return color.NRGBA{R: 0x1c, G: 0x48, B: 0x90, A: 0xff}
...
func (wfnTheme) Font(s fyne.TextStyle) fyne.Resource {
	if s.Monospace {
...
func (wfnTheme) Icon(n fyne.ThemeIconName) fyne.Resource {
	return theme.DefaultTheme().Icon(n)
}

func (wfnTheme) Size(s fyne.ThemeSizeName) float32 {
	switch s {
